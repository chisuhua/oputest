...
def gen_add_basic_test():
  src0 = Bits32( random.randint(0,0x1fffffff) )
  src1 = Bits32( random.randint(0,0x1fffffff) )
  dest = src0 + src1
  return """
  v_mov_b32 v32, 0x{}
  v_mov_b32 v31, 0x{}
  v_mov_b32 v33, 0x{}
  v_add_i32 v30, v31, v32
  v_cmp_eq_i32	tcc2,	v30, v33
  s_cbranch_tccz tcc2,	bb_exit
  """.format(src0, src1, dest)
#-------------------------------------------------------------------------
# gen_dest_dep_test
#-------------------------------------------------------------------------
